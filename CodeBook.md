...
combinedSet - dataset returned combined of subject, activities and observations in one set. 
	...
	set is aggregated on all columns except on ones on which it is grouped on
	it is saved into file on disc and returned from script as variable
	

list of variables in raw data explained as features:
===================================================
